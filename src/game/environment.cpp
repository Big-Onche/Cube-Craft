...
namespace game
{
    namespace environment
    {
        ...
        {
            float hour;
            int sunlightcolor, skylightcolor;
            float sunlightintensity, skylightintensity;
        };

        static const lightingkey lightingkeys[] =
        {
            {  0.0f, 0x8090C0, 0x101830, 0.06f, 0.16f },
            {  5.0f, 0x7180B0, 0x182342, 0.05f, 0.20f },
            {  6.0f, 0xFF6A3D, 0x6C6F8F, 0.30f, 0.48f },
            {  7.0f, 0xFFC080, 0x98B5D0, 0.75f, 0.78f },
            {  8.0f, 0xFFF8E0, 0xBEE1FF, 1.00f, 1.00f },
            { 16.0f, 0xFFF8E0, 0xBEE1FF, 1.00f, 1.00f },
            { 17.0f, 0xFFC080, 0x98B5D0, 0.75f, 0.78f },
            { 18.0f, 0xFF6238, 0x696985, 0.28f, 0.45f },
            { 19.0f, 0x7180B0, 0x182342, 0.05f, 0.20f },
            { 24.0f, 0x8090C0, 0x101830, 0.06f, 0.16f }
        };
