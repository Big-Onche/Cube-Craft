...
static const int msgsizes[] =
{
    ...
    N_EDITMODE, 2, N_EDITENT, 11, N_EDITF, 16, N_EDITT, 16, N_EDITM, 16, N_FLIP, 14, N_COPY, 14, N_PASTE, 14, N_ROTATE, 15, N_REPLACE, 17, N_DELCUBE, 14, N_CALCLIGHT, 1, N_REMIP, 1, N_EDITVSLOT, 16, N_UNDO, 0, N_REDO, 0, N_NEWMAP, 2, N_GETMAP, 1, N_SENDMAP, 0, N_CLIPBOARD, 0, N_EDITVAR, 0, N_EDITAUTHOR, 3,
...
struct gameent : dynent
{
    ...
    float renderbodyyaw;
    int smoothmillis, renderbodyyawmillis;
    string name;
    ...
    gameent() : clientnum(-1), privilege(0), ping(0), lastupdate(0), plag(0), edit(NULL),
                ...
                renderbodyyaw(0), smoothmillis(-1), renderbodyyawmillis(-1)
    {
        type = ENT_PLAYER;
